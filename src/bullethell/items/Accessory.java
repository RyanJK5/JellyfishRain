...
public class Accessory extends Item {
    ...
    public Accessory(String name) throws IOException {
        super(name);
    }

    public Accessory(BufferedImage sprite, String name) throws IOException {
        super(sprite, name);
    }
    ...
    public Accessory clone() {
        try {
            Accessory obj = new Accessory(sprite, name);
